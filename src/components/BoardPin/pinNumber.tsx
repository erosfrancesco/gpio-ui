...
function BoardPinNumber({ pin }: BoardPinProps) {
  ...
  return (
    <div className="pin_number_wrapper">
      <div
        className={"pin_number " + typeClassNames[type]}
        onClick={toggleSelected}
      >
        <div
          className={"pin_number_selected" + (selected ? "" : " dontDisplay")}
        >
          <span className="pin_number_content">
            {(number < 10 ? "0" : "") + "" + number}
          </span>
        </div>
      </div>
